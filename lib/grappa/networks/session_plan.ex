defmodule Grappa.Networks.SessionPlan do
  ...
  def base_plan(
    ...
    %{
      ...
      # decrypted-on-load plaintext (accessors), nil when unset. Threaded
      # into Session.Server state and expanded + run at 001, before the
      # built-in identify and before autojoin. Shared by the user + visitor
      # base plan; a visitor credential normally carries neither.
