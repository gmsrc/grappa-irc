defmodule Grappa.HotReloadTest do
  ...
  # migrate_and_reload/2 is NOT tested here: it needs a live supervised
  # pool, so it lives in test/grappa/migrations/hot_deploy_migrate_test.exs
  # alongside the other real-database migration tests.
end
